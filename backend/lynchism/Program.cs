...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!_context.Products.Any())
    {
        var opiumDrop = new List<Product>
        {
            ...
            new Product { Name = "Chrome-Trim Biker Denim", Description = "Classic biker silhouette updated with silver metallic accents, padding and chains. Heavy-duty denim ensures structured stacks.", Price = 5300, Category = "Pants", ImageURL = "https://i.ibb.co/67vjc7pC/CHROME-TRIM-BIKER-DENIM.webp", Sizes = GetDefaultSizes() },
